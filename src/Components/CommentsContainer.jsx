  ...
  return (
    <div className="flex flex-col shadow-sm bg-gray-100 p-2 rounded-lg my-2">
      ...
      <div className="pl-6 border-l-2 border-gray-300 ml-4">
        {retplies?.length > 0 && <CommentList comments={retplies} />}
      </div>
    </div>
  );
};
